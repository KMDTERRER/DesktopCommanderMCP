...
import { server, flushDeferredMessages, handleServerInitialized } from './server.js';
...
async function runServer() {
  try {
    ...
    server.oninitialized = async () => {
      ...
      // Keep this as the single lifecycle owner and compose all post-init phases here.
      await handleServerInitialized();
